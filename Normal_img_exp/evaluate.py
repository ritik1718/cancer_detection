...
MODEL_MAP = {
    ...
    'densenet_solo': ('densenet_solo.py', 'DenseNetSolo'),
    'vit_solo': ('vit_solo.py', 'ViTSolo'),
}
...
Examples:
  ...
  python resnet_Exp/evaluate.py densenet_solo
  python resnet_Exp/evaluate.py vit_solo
        """
    )
    parser.add_argument(
        'model_name',
        type=str,
        help='Name of the model to evaluate (e.g., resnet_solo, resnet_vit, axial_solo, axial_resnet, mobilenet_solo, axial_vit, mobilenet_vit, axial_densenet, swin_transformer, resnet_swintransformer, densenet_swintransformer, densenet_solo, vit_solo)'
    )
