...
from src.datasets.oral_cancer_dataset import OralCancerDataset, get_transforms # Keeping original just in case, but previously used src.dataset
from src.dataset import OralCancerDataset, get_transforms

# ============================================
# EXPERIMENT 7: Deeper Classifier Head
# Description: Adds more layers to the classification head.
# Comparison: A deeper classifier can learn more complex non-linear combinations of the fused features.
# Architectures: DenseNet121 + ViT-Base
# Classifier: 2 Hidden Layers (1024 -> 512 -> 2)
# ============================================
...
EXPERIMENT_NAME = 'exp7_deep_classifier'
...
class HybridViTDenseNet(nn.Module):
    def __init__(self, num_classes=2, pretrained=True):
        ...
        self.classifier = nn.Sequential(
            ...
            nn.BatchNorm1d(1024),
            nn.ReLU(),
            nn.Dropout(0.4), # Increased dropout for deeper net
