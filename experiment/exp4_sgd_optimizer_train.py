...
# Description: Uses Stochastic Gradient Descent instead of AdamW.
# Comparison: SGD often generalizes better than Adam/AdamW but converges slower.
...
BATCH_SIZE = 4
NUM_EPOCHS = 30
LEARNING_RATE = 1e-3 # SGD usually needs higher LR than Adam
WEIGHT_DECAY = 1e-4
PATIENCE = 8
...
EXPERIMENT_NAME = 'exp4_sgd_optimizer'
