...
# ============================================
# EXPERIMENT 1: Baseline Hybrid (Concatenation)
# Description: Standard concatenation of DenseNet and ViT features.
# Comparison: Baseline for all other experiments.
# Architectures: DenseNet121 (Local) + ViT-Base (Global)
# Fusion: Concatenation (1024 + 768 = 1792 dims)
# Optimizer: AdamW
# ============================================
...
# Paths
# Assuming running from experiment folder, go up one level
...
EXPERIMENT_NAME = 'exp1_baseline_concat'
# Save model in the experiment folder for isolation
...
def main():
    ...
    print(f"   Description: Baseline Hybrid Model (Concatenation)")
