...
# ============================================
# EXPERIMENT 5: Batch Size 8
# Description: Increases batch size to 8 to test stability and batch norm stats.
# Comparison: Larger batch sizes provide more stable gradient estimates but use more VRAM.
# Architectures: DenseNet121 + ViT-Base (Baseline Concatenation)
# Batch Size: 8 (vs 4 in baseline)
# ============================================
...
EXPERIMENT_NAME = 'exp5_batch_size_8'
