...
# ============================================
# EXPERIMENT 10: Adam Optimizer
# Description: Uses standard Adam optimizer instead of AdamW.
# Comparison: AdamW decouples weight decay, but sometimes standard Adam works better for certain architectures or data regimes.
# Architectures: DenseNet121 + ViT-Base
# Optimizer: Adam (vs AdamW in baseline)
# ============================================
...
EXPERIMENT_NAME = 'exp10_adam_optimizer'
