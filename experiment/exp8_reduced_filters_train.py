...
from src.datasets.oral_cancer_dataset import OralCancerDataset, get_transforms # Keeping original just in case
from src.dataset import OralCancerDataset, get_transforms

# ============================================
# EXPERIMENT 8: Reduced Filters
# Description: Reduces the dimensionality of the classifier hidden layers.
# Comparison: Testing if a simpler model with fewer parameters generalizes better (less overfitting).
# Architectures: DenseNet121 + ViT-Base
# Classifier: Hidden Dimension 256 (vs 512 in baseline)
# ============================================
...
EXPERIMENT_NAME = 'exp8_reduced_filters'
...
class HybridViTDenseNet(nn.Module):
    def __init__(self, num_classes=2, pretrained=True):
        ...
        # Reduced Filters Classifier
        self.classifier = nn.Sequential(
            nn.Linear(self.fusion_dim, 256), # Reduced to 256
            nn.BatchNorm1d(256),
            nn.ReLU(),
            nn.Dropout(0.3),
