...
def main():
    ...
    train_dataset = OralCancerDataset(
        ...
        extra_normal_aug=False  # ❌ DISABLE THIS (It was too strong)
    )
    ...
    # We punish mistakes on Normal 2.5x more than OSCC
    class_weights = torch.tensor([2.5, 1.0], dtype=torch.float32).to(Config.DEVICE)
